...
export async function getExperiences(): Promise<Experience[]> {
    ...
    const published = experiences.filter((exp) => exp.published).sort((a, b) => a.order - b.order)
...
export async function getSocialLinks(): Promise<SocialLink[]> {
    ...
    const published = socialLinks.filter((link) => link.published).sort((a, b) => a.order - b.order)
