            ...
            <div className="container py-12 max-w-4xl">
                    ...
                    <div className="flex flex-col items-start gap-4 md:flex-row md:justify-between">
                        <div className="flex-1 space-y-4">
                            ...
                            <div className="flex gap-4">
                                ...
                                <LinkButton href="https://github.com/AlenVelocity" target="_blank">
                                    GitHub
                                </LinkButton>
                ...
                <section className="space-y-6">
                    ...
                    <p className="text-muted-foreground text-base">
                        ...
                        (both server and client w/ NextJS and Vue), Rust, anyhing LLMs and Transformers related, AWS and
                    ...
                    <p className="text-muted-foreground text-base">
                        ...
                        <LinkButton href="https://www.atlus.com/smt5v/" target="_blank" className="text-base">
                            SMTV:V
                        </LinkButton>{' '}
                ...
                <section className="space-y-6">
                    ...
                    <div className="text-muted-foreground text-base">
                        ...
                        <LinkButton href="https://wa.me/919744375687" target="_blank" className="text-base">
                            Whatsapp
                        </LinkButton>{' '}
                        or{' '}
                        ...
                        <LinkButton href="mailto:alenyohannan71@gmail.com" className="text-base">
                            email
                        </LinkButton>{' '}
                        or{' '}
                        <LinkButton href="/meeting" className="text-base">
                            schedule a meeting
                        </LinkButton>
                        .
                    </div>
